  ...
  renderPagination = () => {
    ...
    const ActiveDot = this.props.activeDot || (
      <View
        style={[
          {
            backgroundColor: this.props.activeDotColor || color.gray500,
            width: 6,
            height: 6,
            borderRadius: 3,
            marginLeft: this.props.applyDotNewPosition == false ? 3 : 5,
            marginRight: this.props.applyDotNewPosition == false ? 3 : 5,
            marginTop: 3,
            marginBottom: 3,
          },
    ...
    const Dot = this.props.dot || (
      <View
        style={[
          {
            backgroundColor: this.props.dotColor || color.gray200,
            width: 6,
            height: 6,
            borderRadius: 3,
            marginLeft: this.props.applyDotNewPosition == false ? 3 : 5,
    ...
    return (
      <View
        ...
        style={[
          ...
          { marginBottom: this.props.applyDotNewPosition == false ? 0 : -25 },
        ]}
      >
        {dots}
      </View>
